...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p  style="border: 3px solid #007DD1; padding:2%; text-align:justify;">O evento "Jogos de Vero" de Overwatch foi realizado pela primeira vez simultaneamente aos Jogos Olmpicos de Verão de 2016 e, desde então, é realizado anualmente. Os eventos geralmente so temáticos em torno de esportes e atividades de verão. Durante este evento, um modo especial de jogo chamado Lúcioball estará disponível. O Lúcioball foi pensado como um jogo de futebol futurista em que dois times de trs personagens de Lúcio tentam acertar a baliza do adversário. Jogados em partidas de quatro minutos no mapa especial do estádio, Estádio das Rãs, os jogadores usam dois tipos de ataques para controlar os movimentos da bola: principalmente, um ataque corpo a corpo e um estrondo snico secundário e poderoso que também pode repelir os adversrios (frequentemente chamado "booping" pelos jogadores). Os jogadores também podem usar as vantagens ambientais do nível (por exemplo, plataformas de salto e paredes de aumento de velocidade) para garantir uma vantagem estratégica no campo. O PC Gamer sentiu que o modo parecia mais um "jogo de carnaval multijogador do que um modo autônomo desenvolvido. "</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p  style="border: 3px solid #007DD1; padding:2%; text-align:justify;">Os eventos Winter Wonderland normalmente acontecem no final do ano civil e no ano novo cronometrado com o inverno no hemisfério norte. Seus cosméticos tendem a apresentar tanto cosmticos com tema de inverno quanto aqueles relacionados ao Natal e outros eventos festivos semelhantes.

                    Dois modos de evento foram adicionados durante o Winter Wonderland. O primeiro é um modo deathmatch chamado "Ofensiva de bola de neve de Mei". O modo ocorre no mapa menor Ecopoint: Antarctica, introduzido nos meses anteriores para o jogo deathmatch padro. Seis jogadores cada um joga Mei, mas onde seu Blaster Endotrmico, que normalmente dispara um fluxo de frio prejudicial, pode disparar apenas uma nica bola de neve. Os jogadores devem encontrar uma pilha de bolas de neve espalhadas pelo mapa para recarregar a arma. Além disso, sua habilidade Ultimate permite que ela atire bolas de neve como uma metralhadora por um breve período. Caso contrário, as outras habilidades de Mei (Ice Wall e Cyro-Freeze) permanecem as mesmas. Um nico golpe de bola de neve mata o atingido até que a rodada esteja completa. Kotaku afirma que esse modo geralmente não foi bem recebido pelos jogadores, pois o ato de ter que recarregar o Blaster deixava algum muito vulnervel e, com a mecânica da morte permanente em jogo, o modo no era divertido nem capturava o espírito de uma luta de bolas de neve.
